...
public class CarritoEntityFacadeREST extends AbstractFacade<CarritoEntity> {
    ...
    public CarritoEntityFacadeREST() {
    ...
    public void create(CarritoEntity entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Long id, CarritoEntity entity) {
        super.edit(entity);
    }
    ...
    public CarritoEntity find(@PathParam("id") Long id) {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<CarritoEntity> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
